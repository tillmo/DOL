 \newcommand{\version}{Draft Version 3.15}
...
\let\ifpdf\@undefined
% Need to use the mathematical \begin{definition}…\end{definition} environment; that's incompatible with \definition from isov2; therefore we rename the latter
...
%% Proper ISO preamble starts here
\standard{OntoIOp -- DOL -- \version}
\yearofedition{\today}
\languageofedition{(E)}
...
\title{% We don't have an introductory title
}{Ontology Integration and Interoperability (OntoIOp)}{
%Part 1: The Distributed Ontology Language (DOL)
}

\begin{cover}

{\bf \Large \today~~ \version}

\todonote[author=Christoph Lange,date=D:201108212124+02'00']{How to read such comments:\textLF
TODO: something that the authors are aware of and will do later\textLF
Q-ALL: a question to everyone whom it concerns (usually all experts)\textLF
Q-AUT: a question to the closer circle of authors of this document (i.e. the project team plus maybe a few others)\textLF
@Person: Immediate question or request for help\textLF
FYI: a note to inform the reader (any suggestions for rephrasing the text in a way that makes such a note obsolete are welcome)}
...
The following features are essential to the design of this \IS\CLnote[date=D:201110060000+02'00']{Proposal for restructuring this (due to Michael Grüninger):\textLF
\begin{enumerate}
\item heterogeneity
\item modularity
\begin{enumerate}
...
\begin{outofscope}{\IS}
\item the (re)definition of elementary ontology languages, \ie languages that allow for declaring ontology non-logical symbols\CLnote[type=todo]{We somehow need to rephrase this (here and elsewhere); it reads quite ugly.  Maybe just say “non-logical symbols”?  Or, if absolutely necessary, reorder the words into “non-logical ontology symbols”.} and
...
% amendments) applies.
  \isref{W3C/TR REC-owl2-syntax:2009}{OWL 2 Web Ontology Language: Structural Specification and Functional-Style Syntax. W3C Recommendation, 27 October 2009. \url{http://www.w3.org/TR/2009/REC-owl2-syntax-20091027/}}
  \isref{ISO/IEC 14977:1996}{Information technology – Syntactic metalanguage – Extended BNF}
  \isref{W3C/TR REC-xml:2008}{Extensible Markup Language (XML) 1.0 (Fifth Edition). W3C Recommendation, 26 November 2008. \url{http://www.w3.org/TR/2008/REC-xml-20081126/}}
  \isref{W3C/TR REC-owl2-profiles:2009}{OWL 2 Web Ontology Language: Profiles. W3C Recommendation, 27 October 2009. \url{http://www.w3.org/TR/2009/REC-owl2-profiles-20091027/}}
  \isref{ISO/IEC 24707:2007}{Information technology – Common Logic (CL): a framework for a family of logic-based languages}
  \isref{OMG Document ptc/2010-11-14:}{OMG Unified Modeling Language™ (OMG UML), Superstructure, Version 2.4. \url{http://www.omg.org/spec/UML/2.4/Superstructure}. Section 7 (Classes)}
  \isref{IETF/RFC 3986}{Uniform Resource Identifier (URI): Generic Syntax. January 2005. \url{http://tools.ietf.org/html/rfc3986}}
  \isref{IETF/RFC 3987}{Internationalized Resource Identifiers (IRIs). January 2005. \url{http://tools.ietf.org/html/rfc3987}}
  \isref{IETF/RFC 5147}{URI Fragment Identifiers for the text/plain Media Type.  April 2008. \url{http://tools.ietf.org/html/rfc5147}}
  \isref{W3C/TR REC-rdf-concepts:2004}{Resource Description Framework (RDF): Concepts and Abstract Syntax.  W3C Recommendation, 02 February 2004.  \url{http://www.w3.org/TR/2004/REC-rdf-concepts-20040210/}}
  \isref{W3C/TR REC-xml-names:2009}{Namespaces in XML 1.0 (Third Edition). W3C Recommendation, 8 December 2009. \url{http://www.w3.org/TR/2009/REC-xml-names-20091208/}}
  \isref{W3C/TR REC-rdfa-core-20120607}{RDFa Core 1.1.  Syntax and processing rules for embedding RDF through attributes. W3C Recommendation, 07 June 2012. \url{http://www.w3.org/TR/2012/REC-rdfa-core-20120607/}}
  % This standard has no unique year, as it consist of multiple parts (see http://tools.ietf.org/html/rfc3629#ref-ISO.10646)
  \isref{ISO/IEC 10646}{Information technology – Universal Multiple-Octet coded Character Set (UCS)}
  %\isref{W3C/TR REC-rdf-sparql-query:2008}{SPARQL Query Language for RDF. W3C Recommendation, 15 January 2008. \url{http://www.w3.org/TR/2008/REC-rdf-sparql-query-20080115/}}
  \isref{W3C/TR REC-rdf-schema:2004}{RDF Vocabulary Description Language 1.0: RDF Schema. W3C Recommendation, 10 February 2004.\\ \url{http://www.w3.org/TR/2004/REC-rdf-schema-20040210/}}
  \isref{W3C/TR REC-rdf-mt:2004}{RDF Semantics.  W3C Recommendation, 02 February 2004.  \url{http://www.w3.org/TR/2004/REC-rdf-mt-20040210/}}
\end{nreferences}
...
\begin{symbols}
\symboldef{CASL}{Common Algebraic Specification Language, specified by the Common Frame\-work Initiative}
...
\clause{Requirements and design overview}
...
\sclause{DOL design}\label{c:design:overview}
...
\ssclause{DOL allows for expressing logically heterogeneous ontologies and literal reuse of existing ontologies.}
...
\ssclause{DOL allows for expressing links between ontologies.}\label{c:req:links}
...
\ssclause{DOL allows for expressing ontologies and links at different levels of detail}\label{c:explicit}
...
\ssclause{DOL allows for rich annotation and documentation of ontologies.}\label{c:req:annotation}
...
% and the Grothendieck construction [\bref{GrothendieckInstitutions}].
...
%using the theory of [\bref{ArieliAvron2000}], needs still to be worked out.
...
[\bref{OWLTime},\bref{OWLSTime}].  DOL would instead allow for modeling
...
temporal conceptual data modelling [\bref{Artale02},\bref{Artale07a}];
...
a leaner variant TDL-Lite [\bref{Artale07time}], where notions such as
